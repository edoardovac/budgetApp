...
-- empty description
('Miscellaneous', '');
-- default value for description ('No description')
INSERT INTO Category (name) VALUES ('Random');

-- populates expense table
...
-- populates income table
INSERT INTO Income (name, description, import, date, type, fixed, categoryId) VALUES
